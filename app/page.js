...
export default function Home() {
    ...
    useEffect(() => {
      const typed = new Typed(el.current, {
        strings: ['JavaScript', 'React', 'Frontend Development', 'Backend Development', 'Tech Trends'],
        typeSpeed: 50,
      });
      ...
      <section className="container px-4 py-10 mx-auto lg:h-128 lg:space-x-8 lg:flex lg:items-center">
        <div className="w-full text-center lg:text-left lg:w-1/2 lg:-mt-8">
          <h1 className="text-3xl leading-snug text-gray-800 dark:text-gray-200 md:text-4xl">
            <span className="font-semibold">Explore the world</span> of coding <br className="hidden lg:block" /> and development with <span className="font-semibold underline decoration-primary"><span ref={el} /></span>
          </h1>
          <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
            Discover insightful articles, tutorials, and tips to <br className="hidden lg:block" /> enhance your coding journey and stay updated with the latest trends.
          </p>
        ...
        <div className="w-full mt-4 lg:mt-0 lg:w-1/2">
          <img src="https://www.creative-tim.com/twcomponents/svg/website-designer-bro-purple.svg" alt="Coding Blog" className="w-full h-full max-w-md mx-auto" />
        </div>
      </section>
